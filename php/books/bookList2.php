...
<body>
    ...
    $sql = "SELECT book.bookid, book.bookname, typebook.typename, statusbook.statusname, book.publish, book.unitprice, book.unitrent, book.dayamount, book.picture, book.bookdate 
            FROM book
